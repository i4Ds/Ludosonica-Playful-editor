Sidebars.Properties.AdvancedSwitch = function ( editor, propertiesContainer ) {
	...
	var switchMode = function(advanced)
	{
		if ( advanced === false || ( advanced === undefined && workMode == 'advanced' ) )
		{
			...
			Logger.info( $(propertiesContainer), "logged by Sidebars.Properties.AdvancedSwitch.js, row 18" );
			switchButton
		...
		else
		{
			...
			Logger.info( $(propertiesContainer), "logged by Sidebars.Properties.AdvancedSwitch.js, row 28" );
			switchButton
