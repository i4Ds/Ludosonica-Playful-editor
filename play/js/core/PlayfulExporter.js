    ...
    parse: function (object) {
        ...
        var parseTemplates = function (templates) {
            ...
            for (var i = 0; i < object.templates.length; i++) {
                ...
                for (var j = 0; j < templates[i].instances.length; j++) {

                    if( templates[i].instances[j].template ){
                        instances = parseTemplates( templates[i].instances[j] );
                    } else {
                        instances.push(templates[i].instances[j].uuid);
                    }
                }
                ...
                parsedTemplates.push({
                    ...
                    template: parseObject(templates[i].template),
                    instances: instances
        ...
        var parseObject = function (object) {
            ...
            if (object instanceof THREE.Scene) {
                ...
                if (object.templates && object.templates.length > 0) {
                    ...
                    data.templates = parseTemplates( object.templates );
                ...
                if (object.isLinked !== undefined ){

                    data.isLinked = object.isLinked;
